...

{
    public class Louver : Member
    {
        ...
        public Louver(float Width, float Height, float Thickness)
        {
            this.Height = Height;
            this.Width = Width;
        ...
        LouverLoad LouverLoad { get; set; }
        LouverBlade LoverBlade { get; set; }
        LouverAnchors NorthLouverAnchor { get; set; }
        LouverAnchors EastLouverAnchor { get; set; }
        LouverAnchors WestLouverAnchor { get; set; }
        LouverAnchors SouthLouverAnchor { get; set; }
        ...
        public class LouverAnchors : Connection
        {
            ...
            public class ConnectionType
            {
                ...
                public string AnchorType { set; get; }

                public ConnectionType(AnchorBoltProperties anchorBoltsProperties, string AnchorType)
                {
                ...
                public class AnchorBoltProperties
                {
                    ...
                    public AnchorBoltProperties(float db, float lbt, float lbe, float fuT, float fdT, float fuS, float fdS)
                    {
                        Db = db;
                        Lbt = lbt;
                        Lbe = lbe;
